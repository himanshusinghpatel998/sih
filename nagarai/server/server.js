...
const allowedOrigins = ["https://NagarAI-frontend-7xw0.onrender.com"];
...
app.get("/", (req, res) => {
  res.send(" NagarAI Backend Running Successfully");
});

//  API check
app.get("/api", (req, res) => {
  res.send(" NagarAI API is running successfully...");
});
